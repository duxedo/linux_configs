...
awful.keyboard.append_global_keybindings({
    ...
    awful.key({ modkey, "Mod1"    }, "l"     , function () awful.spawn("xscreensaver-command -lock") end            , {description = "open a terminal", group = "launcher"}),
    ...
    -- Menubar
    awful.key({ modkey            }, "Print" , function () awful.spawn("flameshot gui") end                         , {description = "flameshot", group = "scrot"}),
    awful.key({ modkey , "Mod1"   }, "Print" , function () awful.spawn("sh -c \"flameshot gui --delay 3000\"") end  , {description = "flameshot with 3s delay", group = "scrot"}),
    awful.key({ modkey , "Shift"  }, "Print" , function () awful.spawn("flameshot full --clipboard") end            , {description = "flameshot fullscreen to clipboard", group = "scrot"}),
    awful.key({ modkey            }, "o"     , function () awful.spawn("sh -c \"sleep 3; xprop > ~/xpr\"") end      , {description = "write xprop to ~/xpr in 3 seconds", group = "scrot"}),
