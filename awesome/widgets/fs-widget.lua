...
config.widget_border_color = '#535d6cFF'
config.widget_background_color = '#222222FF'

-- popup
config.popup_bg = '#222222FF'
config.popup_border_width = 1
config.popup_border_color = '#535d6cFF'
config.popup_bar_color = '#aaaaaa'
config.popup_bar_background_color = '#222222FF'
config.popup_bar_border_color = '#535d6cFF'
